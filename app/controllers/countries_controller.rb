class CountriesController < ApplicationController
  ...
  add_breadcrumb :new, :new_country_path, :only=>['new','create']
  add_breadcrumb :edit, :new_country_path, :only=>['edit','update','change_password_user']
  add_breadcrumb :show, :countries_path, :only=>['show']
  layout "admins"
